...
Los drivers son controladores de dispositivos.
...
Conocida también como UCP, procesador, microprocesador, micro, etc....

- __E/S__ :
recoge nuevos datos desde la entrada, se muestran los resultados, se leen/guardan a disco, ...

(Ej. periféricos) El disco duro se considera periférico de e/s.


### Códigos fuente, código objeto y código ejecutable
...
Sólo valido para lenguajes compilados: C, C++.

En lenguajes interpretados no existe código objeto, ni binario. Solo código fuente. Por ejemplo. PHP, Javasript, ...
...
### Modelos de desarrollo de software () Imporatante para examen, saber todos los modelos.

- Modelos clásicos (predictivos) Planifican todo lo que pasara en el futuro, calificación rigida, no se suelen usar son antiguos.
  - Modelo en cascada
  - Modelo en V
- Modelo de construcción de prototipos
- Modelos evolutivos o incrementales son los mas modernos van evolucionando con el tiempo.
...
**Validar se esta haciendo el producto correcto**

**Verificar se está haciendo de le forma correcta**
